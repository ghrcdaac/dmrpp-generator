...
class TestDMRPPCommandLine(TestCase):
    ...
    def test_1_local(self):
        ...
        :return:
        """
        self.assertEqual('get_dmrpp -b foo -o bar.dmrpp bar', DMRPPGenerator.get_dmrpp_command({}, 'foo', 'bar'))
    ...
    def test_2_local_m(self):
        ...
        self.assertEqual('get_dmrpp -M -b foo -o bar.dmrpp bar', DMRPPGenerator.get_dmrpp_command({}, 'foo', 'bar'))
    ...
    def test_6_cumulus_m(self):
        ...
        self.assertEqual('get_dmrpp -M -b foo -o bar.dmrpp bar', DMRPPGenerator.get_dmrpp_command(dmrpp_meta, 'foo', 'bar'))
